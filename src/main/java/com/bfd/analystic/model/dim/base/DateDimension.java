...
public class DateDimension extends BaseDimension {
    //    `dimension_date` : `id``year``season``month``week``day``calendar``type`
    private int id;
    private int year;
    ...
    public void write(DataOutput out) throws IOException {
        ...
        out.writeLong(calendar.getTime());
    }
    ...
    public static DateDimension buildDate(Long time, DateEnum type) {
        ...
        if(DateEnum.DAY.equals(type)){
            ...
            return new DateDimension(year,season,month-1,week,day
